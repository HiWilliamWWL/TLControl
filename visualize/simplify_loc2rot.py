...
import util.rotation_conversions as geometry
import argparse
...
class joints2smpl:
    ...
    def __init__(self, num_frames, device_id, cuda=True):
        ...
        self.num_smplify_iters = 300 #opt_step_num
        self.fix_foot = False
        ...
        # hack shape
        # hack shape
        self.init_mean_shape = torch.zeros_like(self.init_mean_shape)
    ...
    def joint2smpl(self, input_joints, init_params=None):
        ...
        #thetas[:, 15, :] = thetas[15, 15, :] #lock head
