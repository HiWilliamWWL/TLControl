...
from data_loaders.humanml.motion_loaders.model_motion_loaders import get_mtm_loader 
...
global data_transform, traj_transform
data_transform = None
traj_transform = None

#set this joint_in_control for eval ONLY
joint_in_control = [0]
    ...
    for motion_loader_name, motion_loader in motion_loaders.items():
        ...
        with torch.no_grad():
            for idx, batch in enumerate(motion_loader):
                ...
                word_embeddings, pos_one_hots, text, sent_lens, motions, m_lens, token, traj = batch
                ...
                all_text_embeddings_np.append(text_embeddings.cpu().numpy())
...
def evaluation(eval_wrapper, gt_loader, eval_motion_loaders, log_file, replication_times, diversity_times, mm_num_times, run_mm=False):
    with open(log_file, 'w') as f:
        ...
        for replication in range(replication_times):
            ...
            #evaluate_control_errors(eval_wrapper, motion_loaders, f)
