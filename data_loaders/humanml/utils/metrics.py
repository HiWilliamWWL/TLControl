...
def calculate_diversity(activation, diversity_times):
    ...
    if not (activation.shape[0] > diversity_times):
        print("activation.shape[0]  ")
        print(activation.shape[0])
        print("diversity_times  ")
        print(diversity_times)
...
def calculate_multimodality(activation, multimodality_times):
    assert len(activation.shape) == 3 #(64, 1, 512) (32, 30, 512)
    if not (activation.shape[1] > multimodality_times):
        print("activation.shape[1]  ")
        print(activation.shape[1])
        print("diversity_times  ")
        print(multimodality_times)
