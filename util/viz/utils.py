...
def viz_smpl_seq(body, imw=1080, imh=1080, fps=30, contacts=None,
                ...
                cam_offset=[0.0, 4.0, 1.25], ground_color0=[0.6, 0.7, 0.6], ground_color1=[0.3, 0.3, 0.3],
    ...
    #print(np.array([c2c(body.Jtr[i, :22]) for i in range(body.Jtr.size(0))])[:5, 0, :])
    #print(joints_seq[:5, 0, :])
    #exit()
